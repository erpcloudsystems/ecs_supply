...
def get_item_price_qty_data(filters):
    ...
    item_results = frappe.db.sql("""
        select
            officers, employee_name, rank, injury_date, presentation_place, presentation_date, the_committees_date, the_committees_decision, about_the_decision, presentation_case
        from
            `tabPresentation To Medical Commission For Officers`
        where
            `tabPresentation To Medical Commission For Officers`.docstatus = 1
            {conditions}
