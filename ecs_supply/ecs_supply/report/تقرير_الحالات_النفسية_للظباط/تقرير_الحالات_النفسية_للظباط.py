...
def get_emps(filters):
    ...
    if filters.get("recruit"):
        conditions += " AND EE.employee_number = %(recruit)s or EE.name = %(recruit)s or EE.first_name = %(recruit)s  "
    ...
    for item_dict in item_results:
        data = {
            ...
            'service_system': item_dict.service_system,
