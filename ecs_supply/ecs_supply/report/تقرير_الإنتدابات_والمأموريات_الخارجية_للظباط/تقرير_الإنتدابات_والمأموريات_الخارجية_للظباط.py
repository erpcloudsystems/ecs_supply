...
def get_columns(filters):
    columns = [
        ...
        },
        {
            ...
            "fieldname": "custom_mandate_authority",
            "fieldname": "custom_mandate_authority",
            "fieldtype": "Data",
            "width": 200
        },
        {
            ...
            "fieldname": "custom_the_place_of_the_mission",
            "fieldtype": "Data",
            "width": 200
        },
    ]
...
def get_emps(filters):
    ...
    item_results = frappe.db.sql(f"""
      SELECT
        ...
        EE.custom_mandate_authority,
        EE.custom_the_place_of_the_mission
      FROM
    ...
    for item_dict in item_results:
        data = {
            ...
            'custom_mandate_authority': item_dict.custom_mandate_authority,
            'custom_the_place_of_the_mission': item_dict.custom_the_place_of_the_mission,
